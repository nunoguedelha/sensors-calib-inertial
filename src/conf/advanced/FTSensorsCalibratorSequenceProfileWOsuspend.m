...
gridParams = {...
    ...
    'l_shoulder_pitch',-94   ,   6   , 6       ;...
    'l_shoulder_roll' , 16   , 160   , 6       };

left_arm_seqParams.val = SensorDataAcquisition.setValFromGrid(...
    gridBuilder,gridParams,acqVel,transVel,left_arm_seqParams.labels);
...
left_leg_seqParams.labels = {...
    'ctrl'               ,'ctrl'          ,'meas'     ,'meas'      ,'meas'     ,'meas'      ,'meas'     ,'meas'     ,'meas'      ,'meas'      ,'meas'      ,'meas'      ,'meas'      ,'meas'      ;...
    'pos'                ,'vel'           ,'joint'    ,'joint'     ,'joint'    ,'joint'     ,'joint'    ,'joint'    ,'fts'       ,'fts'       ,'fts'       ,'fts'       ,'fts'       ,'fts'       ;...
    'left_leg'           ,'left_leg'      ,'left_arm' ,'right_arm' ,'left_leg' ,'right_leg' ,'torso'    ,'head'     ,'left_leg'  ,'left_foot' ,'right_leg' ,'right_foot','left_arm'  ,'right_arm' };
...
left_leg_seqParams.val = SensorDataAcquisition.setValFromGrid(...
    gridBuilder,gridParams,acqVel,transVel,left_leg_seqParams.labels);

right_leg_seqParams.labels = {...
    'ctrl'               ,'ctrl'          ,'meas'     ,'meas'      ,'meas'     ,'meas'      ,'meas'     ,'meas'     ,'meas'      ,'meas'      ,'meas'      ,'meas'      ,'meas'      ,'meas'      ;...
    'pos'                ,'vel'           ,'joint'    ,'joint'     ,'joint'    ,'joint'     ,'joint'    ,'joint'    ,'fts'       ,'fts'       ,'fts'       ,'fts'       ,'fts'       ,'fts'       ;...
    'right_leg'          ,'right_leg'     ,'left_arm' ,'right_arm' ,'left_leg' ,'right_leg' ,'torso'    ,'head'     ,'left_leg'  ,'left_foot' ,'right_leg' ,'right_foot','left_arm'  ,'right_arm' };
...
%    gridBuilder,gridParams,acqVel,transVel,right_leg_seqParams.labels);
...
torso_seqParams.val = SensorDataAcquisition.setValFromGrid(...
    gridBuilder,gridParams,acqVel,transVel,torso_seqParams.labels);
...
head_seqParams.val = SensorDataAcquisition.setValFromGrid(...
    gridBuilder,gridParams,acqVel,transVel,head_seqParams.labels);
